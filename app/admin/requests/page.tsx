            ...
            <form className="mt-3 flex flex-wrap items-end gap-3">
              ...
              <div>
                ...
                <select
                  ...
                  className="mt-1 rounded-md border border-slate-300 px-2 py-1.5 text-sm shadow-sm focus:border-brand-600 focus:outline-none focus:ring-1 focus:ring-brand-600"
                >
